#!/usr/bin/env python3
"""Baranda BR-002 — vano P1 (V1-004, 016, 024, 029, 034, 040)."""
...
from model.railings.v1_opening_east import (
    NE,
    NW,
    RAILING_HEIGHT,
    SE,
...
def main() -> int:
    ...
    print("BR-002 — vano P1 (V1-004/016/024/029/034/040):")
    print(f"  Altura {RAILING_HEIGHT} u (1.5 m) sobre forjado Z=14")
    print(f"  Norte  {NW} → {NE}")
    print(f"  Oeste  {NW} → {SW}")
    print(f"  Sur    {SW} → {SE}  (este del vano sin baranda)")

    with EditSession("baranda BR-002 vano P1 V1-004/016/024/029/034/040"):
